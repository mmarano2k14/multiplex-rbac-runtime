// ============================================================================
// Multiplexed.Rbac.Core.Runtime.NServiceBus - DI Extensions
// Usage:
// builder.Services.AddMultiplexed.Rbac.CoreNServiceBus();
//
...
namespace Multiplexed.Rbac.Core.Runtime.Messaging.NServiceBus.DI
{
    public static class NServiceBusServiceCollectionExtensions
    {
        ...
        /// which are provided by AddMultiplexed.Rbac.CoreRuntime(...).
        /// </summary>
